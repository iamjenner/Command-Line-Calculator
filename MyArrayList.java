...
public class MyArrayList<E> implements MyList<E>, MyStack<E> {
    ...
    /**
     * Returns a string representation of the list. The string will begin with a
     * '[' and end with a ']'. Inside the square brackets will be a comma-
     ...
     *             || index > size()) The exception message must be: "Index: " +
     ...
     * 
     * @param element element to search for
     * @return an array of each occurrence of the specified element in this list
     */
    ...
    /**
     * Reverses the data in the list. For MyArrayList, the data inside the
     * underlying array is moved. For MyLinkedList, the tail must become the
     * head, and all the pointers are reversed. Both implementations must run in
     * Theta(n).
     */
    public void reverse() {
        for (int i = 0, mid = size / 2,
                opposite = size - 1; i < mid; i++, opposite--) {
